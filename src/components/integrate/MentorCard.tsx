  ...
  return (
    <div className="relative group cursor-default">
      ...
      <img
        ...
        src={img}
        className="min-w-[260px] group-hover:brightness-125 max-w-[260px] h-[580px] select-none duration-700 transition-all"
      />
      <div className="bg-gradient-to-t from-black/50 to-transparent absolute md:opacity-0 group-hover:opacity-100 transition-all duration-1000 inset-0 flex items-center flex-col justify-center">
        <div className="flex flex-col mt-80 text-right items-end pl-16 pr-2">
          ...
          <div className="flex items-center transition-all duration-300 ease-linear group/play gap-x-2 mt-3">
            ...
            <img
              ...
              className="w-12 select-none cursor-pointer transition-all duration-1000"
            />
          </div>
        </div>
      </div>
