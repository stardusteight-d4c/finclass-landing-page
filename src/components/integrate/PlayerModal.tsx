...
export const PlayerModal = ({ setShowPlayer, videoID }: Props) => {
  return ReactDOM.createPortal(
    <div className="w-screen h-screen z-[1000] fixed inset-0 bg-black/60">
      <div className="fixed top-[55%] w-[850px] -translate-y-1/2 left-1/2 -translate-x-1/2">
        <div className="youtubePlayer w-full relative">
          ...
          <iframe
            src={`https://www.youtube.com/embed/${videoID}?controls=0&color=white&theme=dark&fs=0&modestbranding=0`}
