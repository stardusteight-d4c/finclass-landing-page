      ...
      <div className="pt-16 md:pt-28 max-w-screen-xl w-full mx-auto px-4">
        <div className="pt-24 lg:pt-32 pb-28 md:pb-80 lg:pb-52 relative flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="w-full max-w-[400px] md:max-w-none lg:w-[50%] text-center md:text-left mt-20 md:mt-0 z-10">
            ...
            <a className="relative cursor-pointer hover:ring-1  active:scale-95 transition-all duration-300 hover:ring-[#00e7f9] w-full max-w-[311px] inline-flex items-center justify-center tracking-wider px-6 py-3 overflow-hidden font-semibold text-white rounded-md group shadow-lg shadow-white/10">
